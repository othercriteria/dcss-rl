...
GameTurn = NewType("GameTurn", int)
GameTurnDelta = NewType("GameTurnDelta", int)
UiInteractionTokenCapacity = NewType("UiInteractionTokenCapacity", float)
UiInteractionTokenBalance = NewType("UiInteractionTokenBalance", float)
UiInteractionRefillPerTurn = NewType("UiInteractionRefillPerTurn", float)
UiInteractionCost = NewType("UiInteractionCost", float)
UiInteractionOverflowCount = NewType("UiInteractionOverflowCount", int)
